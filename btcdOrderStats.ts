...
async function main() {
  ...
  console.log(`  orderVersion > 2 抵押 BTC: ${formatWithCommas(stats.currentBorrowed.orderVersionGt2.collateral, 4)} BTC， BTCD 数量: ${formatWithCommas(stats.currentBorrowed.orderVersionGt2.tokenAmount, 2).padStart(12, ' ')}`);
